...
var _interaction = require("./partials/interaction");

},{"./partials/interaction":"26Gho"}],"26Gho":[function(require,module,exports) {
window.addEventListener("DOMContentLoaded", ()=>{
    ...
    buyTitle.addEventListener("click", ()=>{
        UnActive(cards);
        if (BuyCard.classList.contains("active")) BuyCard.classList.remove("active");
        else BuyCard.classList.add("active");
    });
    ...
    earnTitle.addEventListener("click", ()=>{
        UnActive(cards);
        if (EarnCard.classList.contains("active")) EarnCard.classList.remove("active");
        else EarnCard.classList.add("active");
    });
    ...
    exchangeTitle.addEventListener("click", ()=>{
        UnActive(cards);
        if (ExchangeCard.classList.contains("active")) ExchangeCard.classList.remove("active");
        else ExchangeCard.classList.add("active");
    });
    ...
    borrowTitle.addEventListener("click", ()=>{
        UnActive(cards);
        if (BorrowCard.classList.contains("active")) BorrowCard.classList.remove("active");
        else BorrowCard.classList.add("active");
    });
...
},{}]},["fH7gS","8ZNvh"], "8ZNvh", "parcelRequiref2b9")
